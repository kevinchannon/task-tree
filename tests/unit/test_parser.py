...
class TestParseArgSpec(unittest.TestCase):
    def test_parse_simple_arg(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("environment")
    ...
    def test_parse_arg_with_default(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("region=eu-west-1")
    ...
    def test_parse_arg_with_type(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("port:int")
    ...
    def test_parse_arg_with_type_and_default(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("port:int=8080")
        self.assertEqual(name, "port")
        self.assertEqual(arg_type, "int")
    ...
    def test_parse_exported_arg(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("$server")
    ...
    def test_parse_exported_arg_with_default(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("$user=admin")
...
class TestParseArgSpecYAML(unittest.TestCase):
    ...
    def test_parse_simple_string_arg(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("key1")
    ...
    def test_parse_arg_with_default_only(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"key2": {"default": "foo"}})
    ...
    def test_parse_arg_with_type_only(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"port": {"type": "int"}})
        self.assertEqual(name, "port")
        self.assertEqual(arg_type, "int")
        self.assertIsNone(default)
        self.assertFalse(is_exported)
    ...
    def test_parse_arg_with_type_and_default(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"port": {"type": "int", "default": 8080}})
        self.assertEqual(name, "port")
        self.assertEqual(arg_type, "int")
        self.assertEqual(default, "8080")
        self.assertFalse(is_exported)
    ...
    def test_parse_exported_arg_dict_syntax(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"$server": {"default": "localhost"}})
        self.assertEqual(name, "server")
        self.assertEqual(arg_type, "str")
    ...
    def test_infer_type_from_string_default(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"name": {"default": "foo"}})
        self.assertEqual(arg_type, "str")

    def test_infer_type_from_int_default(self):
        """Test type inference from int default value."""
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"count": {"default": 42}})
        self.assertEqual(arg_type, "int")

    def test_infer_type_from_float_default(self):
        """Test type inference from float default value."""
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"pi": {"default": 3.14}})
        self.assertEqual(arg_type, "float")

    def test_infer_type_from_bool_default(self):
        """Test type inference from bool default value."""
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"enabled": {"default": True}})
    ...
    def test_parse_inline_dict_syntax(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"key": {"type": "int", "default": 42}})
    ...
    def test_null_default_value(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"arg": {"default": None}})
    ...
    def test_string_defaults_with_special_chars(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"msg": {"default": "hello\nworld"}})
        self.assertEqual(default, "hello\nworld")

    def test_empty_config_dict(self):
        """Test empty config dict defaults to str type with no default."""
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec({"arg": {}})
        self.assertEqual(name, "arg")
        self.assertEqual(arg_type, "str")
        self.assertIsNone(default)
        self.assertFalse(is_exported)
...
class TestArgMinMax(unittest.TestCase):
    ...
    def test_string_format_args_have_no_min_max(self):
        ...
        name, arg_type, default, is_exported, min_val, max_val, choices = parse_arg_spec("count:int=5")
        self.assertIsNone(min_val)
        self.assertIsNone(max_val)
